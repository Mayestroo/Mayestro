  ...
  cartContentMenu[i].addEventListener("click", function () {
    ...
    if (cartContentMenu[i].getAttribute("id") === "selected-products") {
      ...
      if (countSelectedItem > 0) {
        ...
        totalSelectedCounter.innerHTML = "Mahsulot mavjud emas";
      }
      ...
      if (countFavoriteItem > 0) {
        ...
        totalFavoriteCounter.innerHTML = "Mahsulot mavjud emas";
      }
...
function createSelectedProductsContent(image, name, price, discount, time) {
  ...
  newHeading2.textContent = "Mahsulot Tafsiloti";
  ...
  newStrong[0].textContent = "Mahsulot nomi: ";
  newStrong[1].textContent = "Narxi: ";
  newStrong[2].textContent = "Chegirma: ";
  newStrong[3].textContent = "Soni: ";
  newStrong[4].textContent = "Qo'shilgan vaqti: ";
  ...
  newSpan[1].textContent = price + "UZS";
  ...
  newPara[4].appendChild(timeSpan);
  ...
  newShoppingButton[0].textContent = "Sotib Olish";
  newShoppingButton[1].textContent = "Bekor qilish";
...
function addItemsToSelectedProducts(productIndex) {
  ...
  addToCartBtn[productIndex].innerHTML =
    '<span class="icon-cart-arrow-down"></span> Qo`shildi';
...
function removeItemsToSelectedProducts(productIndex) {
  ...
  addToCartBtn[productIndex].innerHTML =
    '<span class="icon-cart-plus"></span> Savatga qo`shish';
...
function createShoppingCartItem(
  ...
  removeBtn.innerHTML = "Olib tashlash";
  ...
  newChildPara[2].innerHTML = itemPrice + " UZS";
  newChildPara[3].innerHTML = itemDiscount + "%";
  newChildPara[4].innerHTML = presentPrice + " UZS";
  newChildPara[5].innerHTML = itemQuantity + "";
  newChildPara[6].innerHTML = totalPrice + " UZS";
...
function controllShoppingProductItems(itemIndex, addToBuyBtn) {
  ...
  if (
    ...
    if (itemQuantity.value === "") {
      alert("Iltimos mahsulot miqdorini kiriting");
    } else {
      alert("Iltimos, mahsulotingizning yaroqli miqdorini kiriting");
    }
  }
}
...
for (let i = 0; i < addToCartBtn.length; i++) {
  ...
  favoriteIcon[i].addEventListener("click", function () {
    ...
    favoriteContent.addEventListener("click", function () {
      activeConfirmationBox("Mahsulot o'chirib tashlansinmi?");
...
removeAllShopItems.onclick = () => {
  if (countAddToBuyItem > 0) {
    activeConfirmationBox("Savatdan barcha narsalar olib tashlansinmi?");
    removeConfirmBtn.onclick = () => {
      for (let i = 0; i < storeShopItemsIndex.length; i++) {
    ...
    alert("Savatda hech narsa topilmadi");
  }
};
